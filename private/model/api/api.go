...
func (a *API) resetImports() {
	a.imports = map[string]bool{
		"github.com/maccam912/aws-sdk-go/aws": true,
	}
}
...
func (a *API) APIGoCode() string {
	a.resetImports()
	a.imports["github.com/maccam912/aws-sdk-go/aws/awsutil"] = true
	a.imports["github.com/maccam912/aws-sdk-go/aws/request"] = true
	if a.OperationHasOutputPlaceholder() {
		a.imports["github.com/maccam912/aws-sdk-go/private/protocol/"+a.ProtocolPackage()] = true
		a.imports["github.com/maccam912/aws-sdk-go/private/protocol"] = true
	}

	for _, op := range a.Operations {
		if op.AuthType == "none" {
			a.imports["github.com/maccam912/aws-sdk-go/aws/credentials"] = true
			break
		}
	}
...
func (a *API) ServiceGoCode() string {
	a.resetImports()
	a.imports["github.com/maccam912/aws-sdk-go/aws/client"] = true
	a.imports["github.com/maccam912/aws-sdk-go/aws/client/metadata"] = true
	a.imports["github.com/maccam912/aws-sdk-go/aws/request"] = true
	if a.Metadata.SignatureVersion == "v2" {
		a.imports["github.com/maccam912/aws-sdk-go/private/signer/v2"] = true
		a.imports["github.com/maccam912/aws-sdk-go/aws/corehandlers"] = true
	} else {
		a.imports["github.com/maccam912/aws-sdk-go/aws/signer/v4"] = true
	}
	a.imports["github.com/maccam912/aws-sdk-go/private/protocol/"+a.ProtocolPackage()] = true
...
func (a *API) InterfaceGoCode() string {
	...
	a.imports = map[string]bool{
		"github.com/maccam912/aws-sdk-go/aws":                   true,
		"github.com/maccam912/aws-sdk-go/aws/request":           true,
