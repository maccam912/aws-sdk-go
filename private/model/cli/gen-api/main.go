...
import (
	...
	"github.com/maccam912/aws-sdk-go/private/model/api"
	"github.com/maccam912/aws-sdk-go/private/util"
)
...
func main() {
	...
	flag.StringVar(&svcImportPath, "svc-import-path", "github.com/maccam912/aws-sdk-go/service", "namespace to generate service client Go code import path under")
	flag.Parse()
	api.Bootstrap()
